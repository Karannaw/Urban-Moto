	...
	<div class="products">
		<div class="container">
			<div class="col-md-4 products-left">
				...
				$pq1 = mysqli_query($con,$sql);
				while($pr1 = mysqli_fetch_array($pq1))
				{
				
				?>
						<li><a href="category.php?cat=<?php echo $pr1['id'] ;?>"><i class="fa fa-arrow-right" aria-hidden="true"></i> 
						<?php echo $pr1['categoryname']; ?>
						</a></li>
				<?php
				}
				?>	
									...
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="products.html"><img title=" " alt=" " src="upload/<?php echo $pr['image']; ?>" style="width:170px;height:100px;"></a>		
