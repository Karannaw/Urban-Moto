...
if($error=="")
{	
$sql="update  product set productname='$productname',image='$f_newname',category='$category',description='$description',price='$price',status='$status' where id = '$id'";
...
<body>
   ...
   ?>
	...
	<?php echo $cr['categoryname']; ?>
						 ...
						 <div class="form-group">
                         <label>Price  </label>
    <input class="form-control" type="text" value="<?php echo $r['price'];?>" name="price">
						 ...
						 <div class="form-group">
                         <label>Image  </label>
						 <img src="../upload/<?php echo $r['image'];?>" style="width:170px;height:100px;" />
